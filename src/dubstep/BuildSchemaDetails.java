...
public class BuildSchemaDetails extends Main{
	...
	public static HashMap<String, List<ArrayList<String>>> buildSchemaPlan(){
		...
		workingSchemaList = new HashMap<String, List<ArrayList<String>>>();
		List<ArrayList<String>> tempPrevSchema = new ArrayList<ArrayList<String>>();
		...
		while(schemaListIterator.hasPrevious()){ 
			...
			if(breakwithallColumns) {
				...
				tempPrevSchema.add(prevSchema);
				workingSchemaList.put(tableName,tempPrevSchema);
