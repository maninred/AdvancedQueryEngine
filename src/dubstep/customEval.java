...
public class customEval extends Eval {
	...
	public PrimitiveValue eval(Column column) throws SQLException {
		...
		//System.out.println("Column Name of Query " + columnName);
		/*
...
//	}
	public static void setWorkingTuple(PrimitiveValue[] currentTuple) throws SQLException {
		...
		for(int i=0; i < Main.workingRecord.length; i++){
			...
			columnSchema.append(Main.tableName);
			columnSchema.append(".");
			columnSchema.append(Main.workingDataSchema.get(Main.tableName).get(i));
			Main.workingRecordMapper.put(columnSchema.toString(), Main.workingRecord[i]);
		}
